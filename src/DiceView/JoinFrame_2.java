...
public class JoinFrame_2 extends JFrame implements ActionListener {
	...
	*/
	...
	public void actionPerformed(ActionEvent ae) {
		if(ae.getSource() == btnInsert){
			String msg = getViewData();	
			System.out.println("가입 완료. 로그인 하십시오.");
...
*/
	...
	public String getViewData(){
		...
		dto.concat(id+"^"+pwd+"^"+name+"^"+tel+"^"+addr+"^"+birth+"^"+job+"^"+gender+"^"+email+"^"+intro+"^");
		/*
		//dto에 담는다.
		dto.setId(id);
		dto.setPwd(pwd);
